...
CREATE TABLE `reserva` (
  ...
  CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`habitacionid`) REFERENCES `habitacion` (`id`),
  CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`personaid`) REFERENCES `persona` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-02-13 23:18:16
